...
svn co https://github.com/immortalwrt/luci/trunk/themes/luci-theme-bootstrap-mod luci-theme-bootstrap-mod
...
# Add luci-app-ssr-plus (subversion old ssr-plus)
pushd package
#git clone --depth=1 https://github.com/fw876/helloworld
#svn co https://github.com/NueXini/NueXini_Packages/branches/v20220412/luci-app-ssr-plus
svn co https://github.com/NueXini/NueXini_Packages/tags/v20220412/luci-app-ssr-plus
popd
